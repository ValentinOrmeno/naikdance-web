  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        nivel: nivel != null && String(nivel).trim() ? String(nivel).trim() : null,
        max_students: typeof max_students === 'number' && max_students > 0 ? max_students : null,
        audience: audience != null ? String(audience).trim() : '',
