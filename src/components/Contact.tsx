...
export default function Contact() {
  return (
    <section id="redes" className="py-20 px-3 sm:px-4 bg-transparent relative z-10 scroll-mt-24 overflow-x-hidden">
      <ScrollReveal>
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 max-w-5xl mx-auto mb-16">
        ...
        <ScrollReveal direction="right" delay={0.08}>
          <div className="bg-naik-dark/70 border border-white/20 p-8 text-center flex flex-col gap-4 items-center rounded-2xl backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_18px_30px_rgba(0,0,0,0.35)]">
            <div className="w-14 h-14 rounded-xl inline-flex items-center justify-center bg-white/10 text-3xl">
              <FaTiktok />
            </div>
            <h3 className="m-0 font-anton uppercase tracking-widest text-white text-xl">
            ...
            <p className="text-gray-300">Seguinos en @naik.dance</p>
            <div className="flex gap-3 flex-wrap justify-center w-full">
              <a
                href="https://www.tiktok.com/@naik.dance"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full uppercase font-extrabold tracking-wider text-sm border border-transparent bg-black text-white hover:bg-gray-900 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(0,0,0,0.35)]"
              >
